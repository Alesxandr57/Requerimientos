...
**-** fue muy complicado al inicio por que yo no sabia como se manejaban estas herramientas ya que era la primera vez que los usaba y esto se vio en que nuestro primer avance del juego fue despues de una semana por los errores que se nos daba hicimos 4 repocitorios y los tuvimos que borrar por que nos corrompian el juego y no sabimos el por que luego se descubrio que primero se tenian que sincronizar los trbajos de diferentes maneras despues de una brebe explicacion de Eudaldo entendi perfectamente como era el funcionamiento de las aplicaciones y su funcionamiento para poder terminar el proyecto asi finalizarlo a tiempo.
